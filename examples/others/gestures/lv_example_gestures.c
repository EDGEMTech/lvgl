...
static void label_swipe(lv_event_t * gesture_event)
{
    ...
    lv_indev_gesture_type_t type = lv_event_get_gesture_type(gesture_event, LV_INDEV_GESTURE_TWO_FINGERS_SWIPE);

    char * text;

    if(type != LV_INDEV_GESTURE_TWO_FINGERS_SWIPE) {
...
static void label_scale(lv_event_t * gesture_event)
{
    ...
    if(lv_event_get_gesture_type(gesture_event, LV_INDEV_GESTURE_PINCH) != LV_INDEV_GESTURE_PINCH) {
        return;
    }
...
static void label_rotate(lv_event_t * gesture_event)
{
    ...
    lv_indev_gesture_state_t state;
    lv_indev_gesture_type_t type = lv_event_get_gesture_type(gesture_event, LV_INDEV_GESTURE_ROTATE);

    if(type != LV_INDEV_GESTURE_ROTATE) {
        return;
    }
