...
enum {
    ...
    LV_STYLE_FLEX_FLOW              = 120,
    LV_STYLE_FLEX_MAIN_PLACE        = 121,
    LV_STYLE_FLEX_CROSS_PLACE       = 122,
    LV_STYLE_FLEX_TRACK_PLACE       = 123,
    LV_STYLE_FLEX_GROW              = 124,

    LV_STYLE_GRID_COLUMN_ALIGN      = 125,
    LV_STYLE_GRID_ROW_ALIGN         = 126,
    LV_STYLE_GRID_ROW_DSC_ARRAY     = 127,
    LV_STYLE_GRID_COLUMN_DSC_ARRAY  = 128,
    LV_STYLE_GRID_CELL_COLUMN_POS   = 129,
    LV_STYLE_GRID_CELL_COLUMN_SPAN  = 130,
    LV_STYLE_GRID_CELL_X_ALIGN      = 131,
    LV_STYLE_GRID_CELL_ROW_POS      = 132,
    LV_STYLE_GRID_CELL_ROW_SPAN     = 133,
    LV_STYLE_GRID_CELL_Y_ALIGN      = 134,
