...
/**
 * Obtains the current distance in pixels of a two fingers swipe gesture
 * @param gesture_event     pointer to a gesture event
 * @return                  the rotation angle in radian of the current gesture
 */
 ...
 * @return                  the rotation angle in radian of the current gesture
 */
float lv_event_get_two_fingers_swipe_dir(lv_event_t * gesture_event);
 ...
 */
lv_indev_gesture_type_t lv_event_get_gesture_type(lv_event_t * gesture_event, lv_indev_gesture_type_t type);
 ...
 */
void lv_indev_gesture_init_recognizers(lv_indev_t * indev);
